...
import (
	...
	"github.com/apopov-app/ggconfig/example3/cmd/Abin/internal/server"
...
func main() {
	...
	log.Println("🚀 Starting Abin application...")
	...
	serverCfg, ok := global.GetCmdAbinInternalServer()
	if !ok {
		log.Fatal("cmd_Abin_internal_server config not registered")
	}
	...
	log.Println("\n🎉 Abin example completed successfully!")
